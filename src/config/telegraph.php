...
return [
    ...
    "webhook" => [
         ...
         */
        "url" => env("TELEGRAPH_WEBHOOK_URL", "/telegram/{bot_token}"),
        ...
        "handler" => App\Services\Telegram\Handlers\Handler::class,
        /*
    ...
    "storage" => [
        ...
        "stores" => [
            "file" => [
                 ...
                 */
                "driver" =>
                    \DefStudio\Telegraph\Storage\FileStorageDriver::class,
            ...
            "cache" => [
                 ...
                 */
                "driver" =>
                    \DefStudio\Telegraph\Storage\CacheStorageDriver::class,
